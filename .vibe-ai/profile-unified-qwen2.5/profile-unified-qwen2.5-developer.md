...
5. Minimal questions, maximum output  
...
- Suggest instrumentation or logging improvements.
...
# 5. Developer Mode MCP Agents (Unified)
...
- Aggressive root-cause isolation.
...
Developer mode uses slightly higher temperature for creativity in architecture and refactoring.

---

# 10. Final Rule

**Move fast, implement confidently, optimize aggressively.  
Always plan → implement → summarize.**
